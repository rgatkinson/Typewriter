...
public sealed class FileSystemGeneratedFileWriter : IGeneratedFileWriter
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var content = OutputContentFormatter.Format(content: file.Content, output: request.Configuration.Output, insertFinalNewline: file.InsertFinalNewline, finalNewlineCount: file.FinalNewlineCount);
